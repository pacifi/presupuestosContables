<%-- 
    Document   : formEditConsumo
    Created on : 22/06/2013, 06:34:16 PM
    Author     : Pc
--%>
    ...
    <table border="1">
        <body >        
            ...
            <div id="cuadroReporteR" style="width: 30%">
                <h3>Formulario catalogo consumo edit</h3>
                 

                <div>
                    <c:url var="consumoy" value="actualizarCatalogoConsumo.pacifi" />        
                    <fm:form modelAttribute="ActualizarCatalogoConsumo" method="post" action="${consumoy}">
                         <fm:hidden path="idConsumo" /><br>
                        <tbody>
